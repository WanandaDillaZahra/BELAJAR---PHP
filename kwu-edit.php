...
<input value="<?php echo $row["namabarang"]; ?>" type="text" name="namabarang" placeholer="Ex. Ultra Milk " /><br>

<label for="qty">QTY : </label>
<input value="<?php echo $row["qty"]; ?>" type="number" name="qty" placeholer="Ex. 1 " /><br>

<label for="hargabeli">Harga Beli  : </label>
<input value="<?php echo $row["hargabeli"]; ?>" type="number" name="hargabeli" placeholer="Ex. 10000" /><br>
